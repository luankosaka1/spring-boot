...
public class SwaggerConfig {
	...
	private ArrayList<VendorExtension> vendor = new ArrayList<VendorExtension>();
	...
	private ApiInfo infoDocs() {
		return new ApiInfo(title, description, version, terms, this.getContact() , licence, licenceUrl, vendor);
	}
